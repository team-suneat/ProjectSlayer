...
{
    [CreateAssetMenu(fileName = "WeaponSummonConfig", menuName = "TeamSuneat/Config/Summon/Weapon")]
    public class WeaponSummonConfigAsset : XScriptableObject
    {
        [Tooltip("무기 소환 등급별 확률")]
        ...
        private void LogErrorInvalid()
        {
            ...
            {
                Log.Error("무기 소환 데이터는 정확히 6개 등급(일반~신화)이어야 합니다: {0}", name);
                return;
            }
        ...
        {
#if UNITY_EDITOR
            PerformRename("WeaponSummonConfig");
#endif
        }
