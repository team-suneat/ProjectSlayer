...
namespace TeamSuneat.Feedbacks
{
    ...
    public enum GameFeedbackSequenceTrackStates
    { Idle, Down, Up }
    ...
    /// </summary>
    [System.Serializable]
    public class GameFeedbackSequenceNote
    {
        public float Timestamp;
        public int ID;

        public virtual GameFeedbackSequenceNote Copy()
        {
            GameFeedbackSequenceNote newNote = new GameFeedbackSequenceNote();
            newNote.ID = this.ID;
    ...
    /// </summary>
    [System.Serializable]
    public class GameFeedbackSequenceTrack
    {
        public int ID = 0;
        ...
        [ReadOnly]
        public GameFeedbackSequenceTrackStates State = GameFeedbackSequenceTrackStates.Idle;
        ...
        public virtual void SetDefaults(int index)
        {
            ...
            {
                ID = index;
                TrackColor = GameFeedbackSequence.RandomSequenceColor();
                Key = KeyCode.Space;
                Active = true;
                State = GameFeedbackSequenceTrackStates.Idle;
                Initialized = true;
            }
        }
    }
    ...
    /// </summary>
    [System.Serializable]
    public class GameFeedbackSequenceList
    {
        public List<GameFeedbackSequenceNote> Line;
    }

    /// <summary>
    /// This scriptable object holds "sequences", data used to record and play events in sequence
    /// GameFeedbackSequences can be played by GameFeedbacks from their Timing section, by Sequencers and potentially other classes
    /// </summary>
    [CreateAssetMenu(menuName = "MoreMountains/Sequencer/GameFeedbackSequence")]
    public class GameFeedbackSequence : ScriptableObject
    {
        [Header("Sequence")]
        ...
        public GameFeedbackSequenceList OriginalSequence;
        ...
        public List<GameFeedbackSequenceTrack> SequenceTracks;
        ...
        public List<GameFeedbackSequenceList> QuantizedSequence;

        //        [GameFeedbackFInspectorButton("RandomizeTrackColors")]
        [Space]
        [Header("Controls")]
        public bool RandomizeTrackColorsButton;

        protected float[] _quantizedBeats;
        protected List<GameFeedbackSequenceNote> _deleteList;
        ...
        /// <param name="p2"></param>
        /// <returns></returns>
        private static int SortByTimestamp(GameFeedbackSequenceNote p1, GameFeedbackSequenceNote p2)
        {
        ...
        /// </summary>
        public virtual void QuantizeSequenceToBPM(List<GameFeedbackSequenceNote> baseSequence)
        {
            float sequenceLength = Length;
            float beatDuration = 60f / TargetBPM;
            int numberOfBeatsInSequence = (int)(sequenceLength / beatDuration);
            QuantizedSequence = new List<GameFeedbackSequenceList>();
            _deleteList = new List<GameFeedbackSequenceNote>();
            _deleteList.Clear();
            ...
            {
                QuantizedSequence.Add(new GameFeedbackSequenceList());
                QuantizedSequence[i].Line = new List<GameFeedbackSequenceNote>();
                for (int j = 0; j < numberOfBeatsInSequence; j++)
                {
                    ...
                    foreach (GameFeedbackSequenceNote note in baseSequence)
                    {
        ...
        {
            foreach (GameFeedbackSequenceTrack track in SequenceTracks)
            {
