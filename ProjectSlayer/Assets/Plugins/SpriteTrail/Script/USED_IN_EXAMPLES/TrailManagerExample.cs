...
{
    public JF_SpriteTrail.SpriteTrail[] m_Trails;
    ...
    private void OnEnable()
    {
        ...
        m_Character.GetComponent<Rigidbody2D>().linearVelocity = Vector2.zero;
        ...
        m_UI.SetActive(true);
        foreach (JF_SpriteTrail.SpriteTrail _trail in m_Trails)
            _trail.DisableTrail();
